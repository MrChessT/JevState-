...
const ES = {
  ...
  resultados: "He encontrado {n} {inmuebles} que encajan.",
  ...
  intenciones: { buscar: "Buscar inmuebles", refinar: "Cambiar la búsqueda", detalle_inmueble: "Preguntar por un inmueble", comparar: "Comparar inmuebles", valorar_mi_vivienda: "Valorar mi vivienda", pedir_visita: "Pedir una visita", contactar_agente: "Hablar con un agente", crear_alerta: "Crear una alerta", feedback_resultado: "Opinar sobre un resultado", calcular_hipoteca: "Calcular la hipoteca", info_zona: "Saber cómo es una zona", conversar: "Otra cosa" } as Record<string, string>,
  rango: "Precios desde {min} hasta {max}.",
  relativoBarato: "Bajo tu presupuesto a {precio} y te enseño primero los más baratos.",
  ...
  sugerencias: {
    ...
    alquiler: "Ver en alquiler", venta: "Ver en venta", zona: "Cómo es {zona}", portal: "Ver todos en el buscador", buscarZona: "Buscar en {zona}",
    cuota25: "A 25 años", quitar: "Sin «{x}»", subir: "Hasta {precio}", cuota35: "A 35 años", entrada30: "Con 30 % de entrada", entrada10: "Con 10 % de entrada",
  },
  hipoteca: "Para {que}, con un {entrada} % de entrada, a {anos} años y un tipo fijo del {tipo} %, la cuota sería de unos {cuota} al mes.",
  hipotecaAhorro: "Necesitarías tener ahorrados unos {ahorro}: la entrada más un 10 % aproximado de impuestos y gastos (ITP o IVA, notaría, registro). En total pagarías unos {intereses} de intereses.",
  hipotecaAviso: "Es un cálculo orientativo con condiciones típicas; el tipo real depende del banco y de tu perfil.",
  hipotecaSin: "Dime el precio o el inmueble y te calculo la cuota. Por ejemplo: «¿cuánto pagaría al mes por FIC-0012?» o «hipoteca para 200.000 €».",
  hipotecaAlquiler: "{ref} es un alquiler: no necesita hipoteca. La renta es de {precio} al mes.",
  zona: "{zona}: {n} inmuebles en venta con una mediana de {m2}/m² (la mitad central, entre {p25} y {p75} €/m²).",
  zonaAlquiler: "En alquiler hay {n}, con una mediana de {m2}/m² al mes.",
  zonaSinDatos: "No tengo inmuebles publicados en {zona} para darte precios con datos reales.",
  zonaSin: "¿De qué zona quieres saber? Por ejemplo: «¿qué precio medio tiene Cartagena?».",
  zonaFuente: "Calculado con los inmuebles publicados ahora mismo, no con estimaciones.",
  favoritos: "Guardar",
  cuota: "Cuota",
...
const EN: typeof ES = {
  ...
  resultados: "I found {n} {inmuebles} that fit.",
  ...
  intenciones: { buscar: "Search properties", refinar: "Change the search", detalle_inmueble: "Ask about a property", comparar: "Compare properties", valorar_mi_vivienda: "Value my home", pedir_visita: "Book a viewing", contactar_agente: "Talk to an agent", crear_alerta: "Create an alert", feedback_resultado: "Give feedback on a result", calcular_hipoteca: "Work out a mortgage", info_zona: "Learn about an area", conversar: "Something else" },
  rango: "Prices from {min} to {max}.",
  relativoBarato: "I've lowered your budget to {precio} and I'm showing the cheapest first.",
  ...
  sugerencias: {
    ...
    alquiler: "See rentals", venta: "See for sale", zona: "What {zona} is like", portal: "See all in search", buscarZona: "Search in {zona}",
    cuota25: "Over 25 years", quitar: "Without \"{x}\"", subir: "Up to {precio}", cuota35: "Over 35 years", entrada30: "With 30% deposit", entrada10: "With 10% deposit",
  },
  hipoteca: "For {que}, with a {entrada}% deposit, over {anos} years at a fixed {tipo}% rate, the payment would be about {cuota} a month.",
  hipotecaAhorro: "You would need about {ahorro} in savings: the deposit plus roughly 10% in taxes and fees (transfer tax or VAT, notary, land registry). Total interest would be about {intereses}.",
  hipotecaAviso: "This is an indicative calculation with typical terms; the actual rate depends on the bank and your profile.",
  hipotecaSin: "Tell me the price or the property and I'll work out the payment. For example: \"how much a month for FIC-0012?\" or \"mortgage for €200,000\".",
  hipotecaAlquiler: "{ref} is a rental: no mortgage needed. The rent is {precio} a month.",
  zona: "{zona}: {n} properties for sale with a median of {m2}/m² (the middle half between {p25} and {p75} €/m²).",
  zonaAlquiler: "For rent there are {n}, with a median of {m2}/m² a month.",
  zonaSinDatos: "I have no listed properties in {zona} to give you prices based on real data.",
  zonaSin: "Which area would you like to know about? For example: \"what's the average price in Cartagena?\".",
  zonaFuente: "Calculated from the properties listed right now, not from estimates.",
  favoritos: "Save",
  cuota: "Payment",
