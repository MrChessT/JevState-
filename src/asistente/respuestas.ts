...
const ES = {
  ...
  sugerencias: {
    ...
    cuota25: "A 25 años", cuota35: "A 35 años", entrada30: "Con 30 % de entrada", entrada10: "Con 10 % de entrada",
  },
  hipoteca: "Para {que} ({precio}), con un {entrada} % de entrada, a {anos} años y un tipo fijo del {tipo} %, la cuota sería de unos {cuota} al mes.",
  ...
  zona: "{zona}: {n} inmuebles en venta con una mediana de {m2}/m² (la mitad central, entre {p25} y {p75}).",
...
const EN: typeof ES = {
  ...
  sugerencias: {
    ...
    cuota25: "Over 25 years", cuota35: "Over 35 years", entrada30: "With 30% deposit", entrada10: "With 10% deposit",
  },
  hipoteca: "For {que} ({precio}), with a {entrada}% deposit, over {anos} years at a fixed {tipo}% rate, the payment would be about {cuota} a month.",
  ...
  zona: "{zona}: {n} properties for sale with a median of {m2}/m² (the middle half between {p25} and {p75}).",
